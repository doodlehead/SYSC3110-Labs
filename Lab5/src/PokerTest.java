...
public class PokerTest extends junit.framework.TestCase
{
    ...
    public void testRank() {
        ...
        //assertEquals(pair.getRanks().get(pair.getRanks().size() - 1), Card.Rank.SIX); Broken one
        assertEquals(pair.getRanks().get(pair.getRanks().size() - 1), Card.Rank.DEUCE);  
        ...
        //assertEquals(tp.kind(), Hand.Kind.TWO_PAIR); //Optional one
    }
